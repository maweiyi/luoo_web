...
function head_register_cback(a, b) {
    b.data("disabled", 0),
        a.status ? (b.find(".btn-register-submit").hide(), b.find(".btn-register-msg").text(a.msg).show(), setTimeout(function() {
                    check_login(a.uid)
                },
...
function create_share_btns(a, b) {
    ...
    if ("vol" == a.app) var c = url("music/" + parseInt(a.id));
    else if ("musician" == a.app) var c = url("musician/") + "?mid=" + a.id;
    else var c = url(a.app + "/" + parseInt(a.id));
    var d = a.img ? a.img: "",
    ...
    else var h = '<a href="javascript:;" class="btn-action-linkout" data-href="' + e + '" target="_blank"><span class="icon-share-weibo" title="分享到微博"></span></a><a href="javascript:;" class="btn-action-linkout" data-href="' + f + '" target="_blank" title="分享到豆瓣"><span class="icon-share-douban"></span></a><a href="javascript:;" class="btn-action-linkout" data-href="' + g + '" target="_blank" title="分享到QQ空间"><span class="icon-share-qzone"></span></a><a href="javascript:;" class="btn-show-qr" data-href="' + c + '" target="_blank" title="分享到朋友圈"><span class="icon-share-wechat"></span></a>';
    return h
}
function feedback_cback(a, b) {
    b.data("disabled", 0),
        a.status ? ($("#frmFeedback").animate({
                    height: 75
                },
                300,
                function() {
...
function init_player(module_options) {
    ...
    var cssSelector = {
        ...
        cssSelectorAncestor = {
            jPlayer: "#luooPlayerContent",
            cssSelectorAncestor: "#luooPlayerPlaylist"
        },
        luoovolume = $.cookie("luoovolume") ? $.cookie("luoovolume") : .8;
    if ("undefined" != typeof module_options && "undefined" != typeof module_options.autoplay) var autoplay = 0 == module_options.autoplay ? !1 : !0;
    else var autoplay = $.luoo.cfg.auto_play;
    var options = {
        playlistOptions: {
            autoPlay: autoplay,
            loopOnPrevious: !0,
    ...
    return luooPlayer = new jPlayerPlaylist(cssSelectorAncestor, playlist, options),
        $("#luooPlayerPlaylist").bind($.jPlayer.event.ready,
            function() {
        ...
        $("#luooPlayerPlaylist").bind($.jPlayer.event.play,
            function() {
                var trackid = luooPlayer.playlist[luooPlayer.current].id,
                    $track = $("#track" + trackid);
                if ($(".track-item").data("status", "ready"), $track.data("status", "play"), update_playlist_btn_status(), "undefined" != typeof module_options && "undefined" != typeof module_options.updateTitle && 0 != module_options.updateTitle && $("title").text(luooPlayer.playlist[luooPlayer.current].title), "undefined" != typeof module_options && "undefined" != typeof module_options.playCback && eval(module_options.playCback + "()"), parseInt($.luoo.res.uid) > 0 && (clearTimeout(log_int), log_int = setTimeout(function() {
                    ...
                    var wsServer = "ws://muma.luoo.net:8000/",
        ...
        $("#luooPlayerPlaylist").bind($.jPlayer.event.pause,
            function(a) {
                $("#track" + luooPlayer.playlist[luooPlayer.current].id).data("status", "pause"),
                    update_playlist_btn_status()
            }),
        $("#luooPlayerPlaylist").bind($.jPlayer.event.error,
            function(a) {
                console.log(a)
            }),
        $("#luooPlayerPlaylist").bind($.jPlayer.event.volumechange,
            function(a) {
...
function add_lyric_cback(a, b) {
    b.data("disabled", 0),
        1 == a.status ? (a.data && ($("#trackDetailWrapper" + a.data).find(".lyric-content").html(""), show_track_detail(a.data)), $.luoo.close_msg()) : (b.find(".btn-positive").hide(), b.find(".btn-not-ready").text(a.msg).show())
}
function single_report_cback(a, b) {
    b.data("disabled", 0),
        1 == a.status ? $("#singleReportWrapper").animate({
                    height: 0
                },
                300,
                function() {
                    $(this).html("<p>提交成功，感谢你的热心支持</p>").height(45),
                        setTimeout(function() {
                                $.luoo.close_msg()
                            },
                            1500)
...
function send_mail_cback(a, b) {
            ...
            var a = 14,
                ...
                m = function(c, d) {
                    var e, f = a >= 12 ? 3 : 2,
                        ...
                        j = [],
                        k = c.concat(d);
                    for (i[0] = O(k), j = i[0], e = 1; f > e; e++) i[e] = O(i[e - 1].concat(k)),
                        j = j.concat(i[e]);
                ...
                n = function(a, b, c) {
                    ...
                    for (0 === a.length % 16 && (g.push([16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16]), e++), d = 0; g.length > d; d++) g[d] = 0 === d ? v(g[d], c) : v(g[d], h[d - 1]),
                        h[d] = p(g[d], b);
                    return h
                },
                o = function(a, b, c, d) {
                    ...
                    for (f = i.length - 1; f >= 0; f--) j[f] = q(i[f], b),
                ...
                t = function(a) {
                    var b, d = [];
                    if (c) for (b = 0; 4 > b; b++) d[4 * b] = L[a[4 * b]] ^ J[a[1 + 4 * b]] ^ K[a[2 + 4 * b]] ^ I[a[3 + 4 * b]],
                    ...
                    else for (b = 0; 4 > b; b++) d[4 * b] = G[a[4 * b]] ^ H[a[1 + 4 * b]] ^ a[2 + 4 * b] ^ a[3 + 4 * b],
                ...
                w = function(c) {
                    var d, e, f, g, h = [],
                        i = [],
                        j = [];
                    for (d = 0; b > d; d++) e = [c[4 * d], c[4 * d + 1], c[4 * d + 2], c[4 * d + 3]],
                        h[d] = e;
                    for (d = b; 4 * (a + 1) > d; d++) {
                ...
                B = function(a, b) {
                    var c, d;
                    for (d = 0, c = 0; 8 > c; c++) d = 1 === (1 & b) ? d ^ a: d,
                        a = a > 127 ? 283 ^ a << 1 : a << 1,
                        b >>>= 1;
                    return d
                },
                ...
                M = function(a, b, c) {
                    var d, e = l(8),
                        ...
                        g = f.key,
                        h = f.iv,
                        i = [[83, 97, 108, 116, 101, 100, 95, 95].concat(e)];
                    return a = j(a, c),
                        d = n(a, g, h),
                        d = i.concat(d),
                        P.encode(d)
                ...
                O = function(a) {
                    ...
                    function l(a) {
                        for (var b, c = a.length,
                                 d = c + 8,
                                 e = (d - d % 64) / 64, f = 16 * (e + 1), g = [], h = 0, i = 0; c > i;) b = (i - i % 4) / 4,
                            h = 8 * (i % 4),
                            g[b] = g[b] | a[i] << h,
                            i++;
                        return b = (i - i % 4) / 4,
                    ...
                    for (w = l(a), s = x[0], t = x[1], u = x[2], v = x[3], n = 0; w.length > n; n += 16) o = s,
                        p = t,
                        q = u,
                        r = v,
                ...
                P = function() {
                    var a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
                        ...
                        c = function(a) {
                            ...
                            for (c = 0; e.length > c; c += 3) f += b[e[c] >> 2],
                                f += b[(3 & e[c]) << 4 | e[c + 1] >> 4],
                                f += void 0 !== e[c + 1] ? b[(15 & e[c + 1]) << 2 | e[c + 2] >> 6] : "=",
                        ...
                        d = function(b) {
                            ...
                            var c, d = [],
                                e = [],
                                f = [];
                            for (c = 0; b.length > c; c += 4) e[0] = a.indexOf(b.charAt(c)),
        ...
        function(a, b) {
            a.fn.jPlayer = function(c) {
                ...
                return c = !e && f.length ? a.extend.apply(null, [!0, c].concat(f)) : c,
                    e && "_" === c.charAt(0) ? g: (e ? this.each(function() {
                                var e = a(this).data(d),
            ...
            "function" != typeof a.fn.stop && (a.fn.stop = function() {}),
                ...
                a.jPlayer.htmlEvent = ["loadstart", "abort", "emptied", "stalled", "loadedmetadata", "loadeddata", "canplay", "canplaythrough"],
            ...
            a.jPlayer.keys = function(b) {
                ...
                a.jPlayer.prototype = {
                    ...
                    _init: function() {
                        ...
                        if (this.element.empty(), this.status = a.extend({},
                            ...
                            a.jPlayer.platform.android && (this.options.preload = "auto" !== this.options.preload ? "metadata": "auto"), this.formats = [], this.solutions = [], this.require = {},
                                ...
                                }), this.require.video ? this.options = a.extend(!0, {},
                                ...
                                a.each(this.formats,
                                    ...
                                    }), this.html.desired = !1, this.flash.desired = !1, a.each(this.solutions,
                                function(b, d) {
                                ...
                                a.each(this.formats,
                                    ...
                                    }), this.html.used = !1, this.flash.used = !1, a.each(this.solutions,
                                function(b, d) {
                                    a.each(c.formats,
                                        function(a, b) {
                    ...
                    tellOthers: function(b, c) {
                        ...
                        "string" == typeof b && (e && f.splice(1, 1), a.each(this.instances,
                            function() {
    ...
    function(a, b) {
        jPlayerPlaylist = function(b, c, d) {
            ...
            this.current = 0,
                ...
                a(this.cssSelector.repeatone).click(function() {
                    return e.options.playlistOptions.repeatone = !1,
                        a(e.cssSelector.repeatone).hide(),
                        a(e.cssSelector.repeatoneOff).show(),
                        !1
                }),
                a(this.cssSelector.repeatoneOff).click(function() {
                    return e.options.playlistOptions.repeatone = !0,
                        a(e.cssSelector.repeatoneOff).hide(),
                        a(e.cssSelector.repeatone).show(),
                        !1
                }),
            ...
            jPlayerPlaylist.prototype = {
                ...
                _createItemHandlers: function() {
                    ...
                    a(this.cssSelector.playlist).off("click", "a." + this.options.playlistOptions.itemClass).on("click", "a." + this.options.playlistOptions.itemClass,
                        function() {
                            ...
                            return b.current !== c ? b.play(c) : a(b.cssSelector.jPlayer).jPlayer("play"),
                                a(this).blur(),
                                !1
                        }),
                ...
                _updateControls: function() {
                    this.options.playlistOptions.enableRemoveControls ? a(this.cssSelector.playlist + " ." + this.options.playlistOptions.removeItemClass).show() : a(this.cssSelector.playlist + " ." + this.options.playlistOptions.removeItemClass).hide(),
                        ...
                        this.options.playlistOptions.repeatone ? (a(this.cssSelector.repeatone).show(), a(this.cssSelector.repeatoneOff).hide()) : (a(this.cssSelector.repeatone).hide(), a(this.cssSelector.repeatoneOff).show())
                },
    ...
    function($) {
        $.luoo = {
            ...
            qrcode: null,
            init: function(a) {
                return this.root = a.root ? a.root: document.location.href,
                    this.url_static = a.url_static ? a.url_static: this.root + "/static",
                    this.res = a.res ? a.res: {},
                    this.cfg = a.cfg ? a.cfg: {},
                    this
            },
            ...
            destroy_tip: function(a) {
                0 != $.luoo.tips.length && $.each($.luoo.tips,
                    function(b, c) { ! c || a && c.id != a || c.destroy(),
                        c && a && c.id == a ? $.luoo.tips.splice(b, 1) : $.luoo.tips.splice(0, $.luoo.tips.length)
                    })
            },
            msg: function(a, b, c, d, e, f) {
                var g = "undefined" == typeof c ? !1 : c,
                    h = "undefined" == typeof d ? "none": d,
                    e = "undefined" == typeof e ? null: e,
                    f = "undefined" == typeof f ? 410 : f,
                    i = {
                        title: a,
                        content: b,
                        ok: g,
            ...
            $.fn.luooTab = function(a) {
                return $(".tab-item").removeClass("actived"),
                    $(".tab-content-item").hide(),
                    $(this).each(function() {
                        var b = $(this),
                            c = 0;
                        a && (c = $("#tab-" + a).index()),
                            $(".tab-item", b).eq(c).addClass("actived"),
                            $(".tab-content-item", b).hide(),
                            $(".tab-content-item", b).eq(c).show(),
                            b.find(".tab-item").on("click",
                                function() {
                                    var a = $(this),
                                        c = a.index();
                                    $(".tab-item", b).removeClass("actived"),
                                        a.addClass("actived"),
                                        $(".tab-content-item", b).hide(),
                                        $(".tab-content-item", b).eq(c).fadeIn(300)
                                })
                    })
            },
            $.fn.getComments = function() {
                return $(this).each(function() {
                    var a = $(this);
                    $.luoo.post(a.data("url"), a.data(), "get_comment_callback", a),
                        a.on("click", ".ajax-comment-pager a",
                            function(b) {
                                b.preventDefault(),
                                    $.luoo.post($(this).attr("href"), "", "get_comment_callback", a)
                            }),
                        $(".ln-comment-sort").click(function(b) {
                            b.preventDefault(),
                                $.luoo.post($(this).data("url"), "", "get_comment_callback", a),
                                $(".ln-comment-sort").removeClass("current"),
            ...
            $.fn.tip = function(a, b) {
                ...
                return $(this).each(function() {
                    var d = $(this),
                        e = "object" == typeof a ? a: d.data(),
                        f = e.tipid ? e.tipid: "",
                        g = e.target ? e.target: d;
                    f && $.luoo.destroy_tip(f);
                    var h = {};
                    e.adjustx && (h.x = e.adjustx),
                    e.adjusty && (h.y = e.adjusty);
                    var i = {
                        classes: "qtip-luoo"
                    };
                    ...
                    if (e.show ? j.event = e.show: j.event = "click", e.hide) var k = e.hide;
                    else var k = "click";
                    if (e.posmy) var l = e.posmy;
                    else var l = "top center";
                    if (e.posat) var m = e.posat;
                    else var m = "bottom center";
                    var n = d.qtip({
                        id: f,
                        content: {
                            text: function(a, b) {
...
"function" != typeof Array.prototype.map && (Array.prototype.map = function(a, b) {
    var c = [];
    if ("function" == typeof a) for (var d = 0,
                                         e = this.length; e > d; d++) c.push(a.call(b, this[d], d, this));
    return c
}),
Object.keys || (Object.keys = function() {
    ...
    $(document).ready(function() {
        check_login(),
            $("body").on("submit", ".form-ajax",
                function(evt) {
                    ...
                    var cback = function() {};
                    return $form.attr("callback") && (cback = $form.attr("callback")),
                        $.luoo.post($form.attr("action"), $form.serialize(), cback, $form),
                        !0
                }),
            $("body").on("click", ".ajax",
                function(evt) {
                    ...
                    var data = {};
                    return $this.data("param") && eval("data = " + $this.data("param")),
                        $.luoo.post($this.attr("href"), data, cback, $this),
                        !1
                }),
            $("body").on("click", ".btn-action-like",
                function(a) {
                    a.preventDefault();
                    var b = $(this);
                    ...
                    var c = b.data("id"),
                        d = b.data("type"),
                        e = (b.data("fav"), "like_callback");
                    return b.data("cback") && (e = b.data("cback")),
                        c ? (b.data("disabled", !0), $.luoo.post($.luoo.root + "/user/like", {
                                    id: c,
                                    res: $.luoo.res.app[d]
                                },
                                e, b), !1) : !1
                }),
            $("body").on("click", ".luoo-captcha-wrapper img, .luoo-captcha-wrapper a",
                function() {
                    refresh_captcha()
                }),
        ...
        $("#backTop").css("left", b2t_left),
            $("#backTop").click(function(a) {
                a.preventDefault(),
                    $("html, body").animate({
                            scrollTop: 0
                        },
            ...
            $(".container").css("minHeight", $(window).height() - 422),
            $("body").on("mouseenter", "#lnMessage",
                function() {
                    $(this).tip()
                }),
            $("body").on("mouseenter", ".logged-out-wrapper",
                function() {
            ...
            $("body").on("click", ".btn-login-submit",
                function() {
            ...
            $("body").on("focus", ".input-passport",
                function() {
                    $(".btn-login-submit").show(),
                        $(".btn-login-msg").text("").hide()
                }),
            $("body").on("submit", "#register_form",
                function() {
                    var a = $(this),
                        b = a.find('[name="name"]').val(),
                        c = a.find('[name="email"]').val(),
                        d = a.find('[name="password"]').val();
                    if (!$.trim(b) || !$.trim(d)) return $(".btn-register-submit").hide(),
                        $(".btn-register-msg").text("请完善未填项目").show(),
                        !1;
                    var e = b + "|" + d,
                        f = GibberishAES.enc(e, "fuckyouspam"),
                        g = a.find('[name="_h"]').val(),
                        h = a.find('[name="code"]'),
                        i = a.find('[name="rule"]'),
                        j = a.find('[name="code"]').val();
                    if (h.prop("required") && "" == j) return $(".btn-register-submit").hide(),
                        $(".btn-register-msg").text("请完善未填项目").show(),
                        !1;
                    if (!i.prop("checked")) return $(".btn-register-submit").hide(),
                        $(".btn-register-msg").text("注册需同意协议").show(),
                        !1;
                    var k = {
                        name: b,
                        password: d,
            ...
            $("body").on("click", ".btn-register-submit",
                function() {
                    $("#register_form").trigger("submit")
                }),
            $("body").on("submit", "#oauth_register_form",
                function() {
                    var a = $(this),
                        b = a.find('[name="name"]').val(),
                        c = a.find('[name="email"]').val(),
                        d = a.find('[name="password"]').val(),
                        e = a.find('[name="ref"]').val();
                    if (!$.trim(b) || !$.trim(c) || !$.trim(d)) return $("#btnSubmit").hide(),
                        $("#btnMsg").text("请完善未填项目").show(),
                        !1;
                    var f = c + "|" + d,
                        g = GibberishAES.enc(f, "fuckyouspam"),
                        h = a.find('[name="rule"]');
                    if (!h.prop("checked")) return $("#btnSubmit").hide(),
                        $("#btnMsg").text("注册需同意协议").show(),
                        !1;
                    var i = {
                        name: b,
                        password: d,
                    ...
                    return a.data("disabled") ? !1 : ($("#btnSubmit").hide(), $("#btnMsg").text("正在处理...").show(), a.data("disabled", !0), $.post("/register/oauth", i,
                            function(b) {
                                a.data("disabled", !1),
                                    b.status ? ($("#btnSubmit").hide(), $("#btnMsg").text(b.msg).show(), "" != e ? top.location.href = e: top.location.href = "/") : ($("#btnSubmit").hide(), $("#btnMsg").text(b.msg).show())
                            },
                            "json"), !1)
                }),
            $("body").on("click", ".verify",
                function() {
            ...
            $("body").on("focus", ".input-passport",
                function() {
                    $(".btn-register-submit").show(),
                        $(".btn-register-msg").text("").hide()
                }),
            $("body").on("mouseenter", "#lnAccountMore",
                function() {
                    $(this).tip()
                }),
            $("body").on("click", ".btn-dialog-register, .btn-dialog-login",
                function() {
            ...
            $("body").on("click", ".btn-action-share",
                function(a) {
                    a.preventDefault(),
                        a.stopPropagation();
                    var b = {};
                    b.html = create_share_btns($(this).data()),
                        $(this).tip(b)
                }),
            $("body").on("click", ".btn-action-linkout",
                function(a) {
                    a.preventDefault();
                    var b = $(this).data("href");
                    return b ? void window.open(b) : !1
                }),
            $("body").on("click", "#feedback",
                function() {
                    var a = $("#feedbackWrapper").html();
                    $.luoo.msg("反馈建议", a),
                        $(".captcha").attr("src", $(".captcha").data("src"))
                }),
            $("body").on("click", "#btnFeedbackSubmit",
                function() {
                    $("#frmFeedback").submit()
                }),
            $("body").on("click", "#btnFeedbackCancle",
                function() {
                    $.luoo.close_msg()
                }),
            $("body").on("keyup",
            ...
            $("body").on("focus", "#txtLyric",
                function() {
                    var a = $(this).parents(".form-ajax");
                    a.find(".btn-positive").show(),
                        a.find(".btn-not-ready").text("").hide()
                }),
            $("body").on("click", "#cancleAddLyric",
                function() {
                    $.luoo.close_msg()
                }),
            $("body").on("click", ".btn-single-report",
                function() {
                    var a = $(this).data("sid"),
                        b = $(this).data("sname");
                    if (!a) return ! 1;
                    ...
                    $.luoo.msg("歌曲报错", c),
                        $("#singleReportSid").val(a),
                        $("#singleReportName").val(b),
                        $("#singleReportSname").text(b)
                }),
            $("body").on("click", "#txtSingleReportMsg",
                function() {
                    $("#singleReportMsgOther").prop("checked", !0)
                }),
            $("body").on("click", "#singleReportWrapper",
                function() {
                    $(this).find(".btn-positive").show(),
                        $(this).find(".btn-not-ready").hide()
                }),
            $("body").on("click", ".btn-send-mail",
                function() {
                    var a = $(this);
                    return a.data("user") && a.data("uid") ? void $.luoo.get(url("mail/send"), {},
                            function(a, b) {
                                if ( - 1 == a.status) {
                                    ...
                                    $("#mailUserName").text(b.data("user")),
                                        $("#mailUserId").val(b.data("uid"));
            ...
            $("body").on("click", "#btnSendMail",
                function() {
                    $("#frmMail").submit()
                }),
            $("body").on("click", "#btnCancleMail",
                function() {
                    $.luoo.close_msg()
                }),
            ...
            $("body").on("click", ".btn-show-qr",
                function(a) {
                    a.preventDefault(),
                        $.luoo.qrcode.clear(),
                        $.luoo.qrcode.makeCode($(this).data("href")),
                        $.luoo.msg("分享到朋友圈", $("#qrcodeWrapper").html(), void 0, "#000", void 0, 250),
                        $.luoo.destroy_tip()
                })
    });